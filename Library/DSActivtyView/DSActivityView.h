...
@interface DSActivityView : UIView
{
    ...
    UIImageView *_customActivityIndicator;
    UILabel *_activityLabel;
    NSUInteger _labelWidth;
    BOOL _showNetworkActivityIndicator;
    BOOL _usingCustomIndicator;
    NSArray *imageArray;
}
...
// The custom activity indicator view; automatically created on first access:
@property (nonatomic, readonly) UIView *customActivityIndicator;
...
// This will tell our draw routines whether to use the UIActivityIndicatorView or the ImageView
@property (nonatomic) BOOL usingCustomIndicator;

// This holds the images for a custom activity animation 
...
// Creates and adds an activity view centered within the specified view, using the specified label, a fixed label width, and an imageArray.  The fixed width is useful if you want to change the label text while the view is visible.  The image array will be used for a custom indicator.  Returns the activity view, already added as a subview of the specified view:
