...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
	if (self = [super initWithStyle: style reuseIdentifier: reuseIdentifier  ]) {
		...
		//		imageView = [[UIImageView alloc] initWithImage: [[UIImage imageNamed:@"DefaultThumbnailImage.png"] retain]];
...
- (void)setEbayItem:(EbayItem *)newEbayItem {
	
	if (ebayItem != newEbayItem) {
		[ebayItem release];
		ebayItem = [newEbayItem retain];
	}	
...
//		case ItemModel:
//			topLeftLabel.text = ebayItem.brand;
//			//			middleLeftLabel.text = ebayItem.maker;
//			topRightLabel.text = ebayItem.size;
//			bottomRightLabel.text = ebayItem.vintage;
//			break;
//		case ItemSize:
//			topLeftLabel.text = ebayItem.brand;
//			//			middleLeftLabel.text = ebayItem.maker;
//			topRightLabel.text = ebayItem.model;
//			bottomRightLabel.text = ebayItem.vintage;
//			break;
//		case ItemMaker:
//			topLeftLabel.text = ebayItem.brand;
...
//		default:
//			//			middleLeftLabel.text = ebayItem.maker;
//			topLeftLabel.text = ebayItem.size;
//			topRightLabel.text = ebayItem.model;
//			bottomRightLabel.text = ebayItem.vintage;
//			break;
//	}
//	
//	imageView.image = ebayItem.thumbnailImage;
